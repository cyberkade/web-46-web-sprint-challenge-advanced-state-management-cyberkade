...
//4. Within the handleSub and summury passed as arguments. Test that a smurf is correctly added to when the form is submmit function, call your addSmurf action with the smurf name, position, nicknameitted.